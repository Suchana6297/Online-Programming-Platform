...
app.post("/hasCodeFor", function (req, res) {
  ...
  var language = req.body.language;
  cdeModel.find(
    { username: username, pid: pid, language: language },
...
app.get("/openProblemSetter", function (req, res) {
  res.sendFile(__dirname + "/setproblem.html");
});
function createUUID() {
...
app.post("/insert", function (req, res) {
  ...
  userDetails.save(function (err, res1) {
    ...
    responseWrapper.message =
      "User Added Successfully With UserName : " + username;
    responseWrapper.code = 200;
    res.send(responseWrapper);
    return;
  });
